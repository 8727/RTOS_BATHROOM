...
#define NRF24L01_CE_LOW                 *((uint32_t *)(PERIPH_BB_BASE+32*(GPIOB_BASE-PERIPH_BASE+0xC) + 11*4)) = 0 // GPIOB->BSRR = GPIO_BSRR_BR11
#define NRF24L01_CE_HIGHT               *((uint32_t *)(PERIPH_BB_BASE+32*(GPIOB_BASE-PERIPH_BASE+0xC) + 11*4)) = 1 // GPIOB->BSRR = GPIO_BSRR_BS11

#define NRF24L01_CS_LOW                 *((uint32_t *)(PERIPH_BB_BASE+32*(GPIOB_BASE-PERIPH_BASE+0xC) + 12*4)) = 0 // GPIOB->BSRR = GPIO_BSRR_BR12
#define NRF24L01_CS_HIGHT               *((uint32_t *)(PERIPH_BB_BASE+32*(GPIOB_BASE-PERIPH_BASE+0xC) + 12*4)) = 1 // GPIOB->BSRR = GPIO_BSRR_BS12
